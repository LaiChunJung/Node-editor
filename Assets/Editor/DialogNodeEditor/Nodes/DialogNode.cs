...
namespace NodeSystem
{
	public class DialogNode : Node
	{
		...
		public DialogNode(DialogNodeEditor editor, NodeInfo info) : base(editor, info)
		{
			...
			clip = info.clip;
			text = info.text;
			AnimatorState = info.AnimatorState;
			title = info.title;
		}
		...
		public override void Draw()
		{
			...
			AnimatorState = EditorGUILayout.TextField("AnimatorState", AnimatorState);
		...
		{
			return new NodeInfo(GetType().FullName, rect, title, text, AnimatorState, clip, triggers);
		}
