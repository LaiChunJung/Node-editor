...
namespace NodeSystem
{
	...
	public class NodeInfo
	{
		...
		public NodeInfo(string type, Rect rect, string title = null, string text = null, string iAnimatorState =null, AudioClip clip = null, List<string> triggers = null)
		{
			this.type = type;
			this.rect = rect;
			this.title = title;
			this.text = text;
			this.AnimatorState = iAnimatorState;
			this.clip = clip;
