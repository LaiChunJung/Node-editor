...
namespace NodeSystem
{
	public class ActionNode : NodeBase
	{
		...
		private bool isLoadPosition = false;
		...
		{
			Style.normal.background = AssetDatabase.LoadAssetAtPath("Assets/Resources/Textures/grayTex.png", typeof(Texture2D)) as Texture2D;
